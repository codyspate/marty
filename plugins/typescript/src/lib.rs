        ...
        Some(json!({
            ...
            "properties": {
                ...
                "auto_project_references": {
                    "type": "boolean",
                    "description": "Automatically add project references to tsconfig.json files based on workspace dependencies",
                    "default": false
                },
...
/// Update tsconfig.json with project references based on workspace dependencies
...
/// Update all TypeScript projects in a workspace with project references
...
"#).unwrap();
        ...
        let result = update_project_references(
            &api_tsconfig,
            &dependencies,
            &workspace,
            "relative"
    ...
    fn updates_project_references_with_tsconfig_style() {
        ...
        assert_eq!(config.references.len(), 1);
        assert_eq!(config.references[0].path, Some("../shared/tsconfig.json".to_string()));
    }
